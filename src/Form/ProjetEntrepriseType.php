...
class ProjetEntrepriseType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('nomReferenant', TextType::class,[
                'attr' => ['class' => 'form-control', 'autocomplete'=>'off'],
                'label' => 'Nom du référent',
                'required' => false
            ])
            ->add('fonctionReferant', TextType::class, [
                'attr' => ['class' => 'form-control', 'autocomplete'=>'off'],
                'label' => 'Fonction du référent',
                'required' => false
            ])
            ->add('banqueAval', TextType::class, [
                'attr' => ['class' => 'form-control', 'autocomplete'=>'off'],
                'label' => "Banque de l'aval",
                'required' => false
            ])
            ->add('compteBancaireAval', TextType::class, [
                'attr' => ['class' => 'form-control', 'autocomplete'=>'off'],
                'label' => "Compte bancaire de l'aval",
                'required' => false
            ])
//            ->add('updateAt', null, [
//                'widget' => 'single_text',
